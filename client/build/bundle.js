...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  ReactDOM.render(React.createElement(Counter, { title: 'Jill the Counter', multiple: 3 }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Counter = React.createClass({
	  ...
	  multiplyCount: function multiplyCount() {
	    this.setState({ count: this.state.count * 2 });
	  },
	
	  divideCount: function divideCount() {
	    this.setState({ count: this.state.count / 2 });
	  },
